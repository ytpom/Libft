...
#    Updated: 2018/12/08 17:12:04 by jphilip-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRC = ft_atoi.c ft_bzero.c ft_count_words.c ft_find_next_prime.c ft_isalnum.c \
...
ft_strstr.c ft_strsub.c ft_strtrim.c ft_strtrim_any.c ft_swap.c ft_tolower.c \
